...
int main(int argc, char **argv)
{
    ...
    double pomp_percent_array[100];
    double grid_percent_array[100];
    ...
    double pomp_percent = pomp_percent_sum / 100.0;
    double grid_percent = grid_percent_sum / 100.0;
    ...
    pomp_std = sqrt(pomp_std / 99.0);
    grid_std = sqrt(grid_std / 99.0);



    std::cout << "pomp octomap average mapping free amount percent:" << pomp_percent_sum / 100.0 << std::endl;
