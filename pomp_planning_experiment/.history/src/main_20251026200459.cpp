...
int main(int argc, char **argv)
{
    ...
    while (true)
    {
        ...
        if (current_frame == nullptr || frame_idx == 2000)
        {

            std::cout << "frame amount: " << frame_idx << std::endl;
            std::cout << "pomp 95 success: " << pomp_success_95 << std::endl;
            std::cout << "pomp 75 success: " << pomp_success_95 << std::endl;
            std::cout << "pomp 50 success: " << pomp_success_95 << std::endl;
            std::cout << "pomp 25 success: " << pomp_success_95 << std::endl;
