...
int main(int argc, char **argv)
{
    ...
    std::cout << "pomp octomap mapping free amount:" << pomp_octomap->get_mapping_amount()<<std::endl;
    ...
    std::cout << "gridmap mapping free amount:" << pomp_octomap->get_mapping_amount()<<std::endl;
