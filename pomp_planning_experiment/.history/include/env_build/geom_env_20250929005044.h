...
static void sample_boxes_surface(pcl::PointCloud<pcl::PointXYZRGB> &cloud,
                                 std::mt19937 &gen,
                                 double cx, double cy, double cz,
                                 double s,
...
void build_env_pointcloud(ros::NodeHandle &nh, pcl::PointCloud<pcl::PointXYZRGB>::Ptr &cloud, int seed_ = 42)
{
