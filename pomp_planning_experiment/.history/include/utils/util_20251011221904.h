...
{
    int num_boxes;
    std::vector<double> size_min_max;
    std::vector<double> speed; // x y z
};

static boxes boxes_param;
...
namespace pomp_env
{
    ...
    struct env_info
    {
        ...
        void print_info()
        {
            std::cout << "env info: " << std::endl;
            std::cout << "  Number of points: " << points_array.cols() << std::endl;
            std::cout << "  Map size: [" << map_size(0) << ", " << map_size(1) << ", " << map_size(2) << "]" << std::endl;
            std::cout << "  center: [" << cur_center(0) << ", " << cur_center(1) << ", " << cur_center(2) << "]" << std::endl;
