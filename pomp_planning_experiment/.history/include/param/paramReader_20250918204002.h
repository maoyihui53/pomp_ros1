...
bool read_param(const ros::NodeHandle &nh)
{
    ...
    //     return false;
    if (!param_validation<double>(test_here, "/param_/test", nh, false))
        return false; 

    // std::cout<<"test_here: "<<test_here<<std::endl;
    printf(ANSI_COLOR_YELLOW "---------------------------------------------\n" ANSI_COLOR_RESET);
    printf(ANSI_COLOR_GREEN "test_here read successfully: %f\n" ANSI_COLOR_RESET, test_here);
