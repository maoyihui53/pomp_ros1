...
bool read_param(const ros::NodeHandle &nh)
{
    ...
    if (!param_validation<int>(boxes_param.num_boxes, "/param_/geometroy_env/boxes/num_boxes", nh, false))
        return false;
    if (!param_validation<std::vector<double>>(boxes_param.size_min_max, "/param_/geometroy_env/boxes/size", nh, true))
        return false;
    ...
    printf(ANSI_COLOR_CYAN "        boxes:\n" ANSI_COLOR_RESET);
    printf(ANSI_COLOR_CYAN "            num_boxes: %d\n" ANSI_COLOR_RESET, boxes_param.num_boxes);
    printf(ANSI_COLOR_CYAN "            size_min_max: [%f, %f]\n" ANSI_COLOR_RESET, boxes_param.size_min_max[0], boxes_param.size_min_max[1], boxes_param.size[2]);
    printf(ANSI_COLOR_YELLOW "----------------------------------------------\n" ANSI_COLOR_RESET);
