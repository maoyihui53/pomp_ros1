...
bool read_param(const ros::NodeHandle &nh)
{
    ...
    printf(ANSI_COLOR_CYAN "            move speed: x [%f, %f], y [%f, %f], z [%f, %f]   \n" ANSI_COLOR_RESET, boxes_param.speed[0] - boxes_param.speed[3], boxes_param.speed[0] + boxes_param.speed[3], boxes_param.speed[1] - boxes_param.speed[3], boxes_param.speed[1] + boxes_param.speed[3], boxes_param.speed[2] - boxes_param.speed[3], boxes_param.speed[2] + boxes_param.speed[3]
