...
bool read_param(const ros::NodeHandle &nh)
{
    ...
    if (!param_validation<std::vector<double>>(boxes_param.size_min_max, "/param_/geometroy_env/boxes/size", nh, true))
        return false;
    if (!param_validation<std::vector<double>>(boxes_param.speed, "/param_/geometroy_env/boxes/speed", nh, true))
        return false;
    ...
    printf(ANSI_COLOR_CYAN "            speed:\n" ANSI_COLOR_RESET);
    printf(ANSI_COLOR_CYAN "                x [%f, %f],  \n" ANSI_COLOR_RESET, boxes_param.speed[0] - boxes_param.speed[3], boxes_param.speed[0] + boxes_param.speed[3]);
    printf(ANSI_COLOR_CYAN "                y [%f, %f],  \n" ANSI_COLOR_RESET, boxes_param.speed[1] - boxes_param.speed[3], boxes_param.speed[1] + boxes_param.speed[3]);
    printf(ANSI_COLOR_CYAN "                z [%f, %f],  \n" ANSI_COLOR_RESET, boxes_param.speed[2] - boxes_param.speed[3], boxes_param.speed[2] + boxes_param.speed[3]);
