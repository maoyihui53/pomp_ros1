  ...
  class GraphSearch
  {
    public:
     /**
       ...
       */
      GraphSearch(const std::atomic<int16_t>* cMap, int xDim, int yDim, double eps = 1, double cweight = 0.1, bool verbose = false);
      /**
       ...
       * @param verbose flag for printing debug info, optional, default as False
       */
      GraphSearch(const  std::atomic<int16_t>* cMap, int xDim, int yDim, int zDim, double eps = 1, double cweight = 0.1, bool verbose = false);
    ...
    private:
      ...
      const std::atomic<int16_t>* cMap_;
      ...
      const int16_t val_free_ = 0;
      const int16_t val_occ_ = 100;
