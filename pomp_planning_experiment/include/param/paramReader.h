...
bool read_param(const ros::NodeHandle &nh)
{
    ...
    if (!param_validation<std::vector<double>>(boxes_param.size_min_max, "/param_/geometroy_env/boxes/size", nh, true))
        return false;
    if (!param_validation<double>(boxes_param.speed_min, "/param_/geometroy_env/boxes/speed/min", nh, false))
        return false;
    if (!param_validation<double>(boxes_param.speed_max, "/param_/geometroy_env/boxes/speed/max", nh, false))
        return false;
    ...
    printf(ANSI_COLOR_CYAN "                [%f, %f]  \n" ANSI_COLOR_RESET, boxes_param.speed_min, boxes_param.speed_max);
